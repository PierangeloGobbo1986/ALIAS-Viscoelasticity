...
#INTERFACE
l1 = Label(root, text="A.L.I.A.S.: A Lovely Indentation Analysis System - Viscoelastic", font='Helvetica 24 bold', fg = "SteelBlue4").grid(row = 0, column = 0, sticky = W, padx = 200, pady = 2)
